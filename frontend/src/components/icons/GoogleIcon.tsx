// Google's official "G" mark — kept as its real brand colors (not themed
// via the Dawgs palette), per Google's sign-in button branding guidelines.
const GoogleIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 18 18" className={className} aria-hidden="true">
    ...
    <path
      fill="#EA4335"
      d="M9 3.5795c1.3214 0 2.5077.4541 3.4405 1.346l2.5814-2.5814C13.4632.8918 11.4259 0 9 0 5.4818 0 2.4382 2.0168.9573 4.9582L3.964 7.29C4.6718 5.1627 6.656 3.5795 9 3.5795z"
    />
  </svg>
);
