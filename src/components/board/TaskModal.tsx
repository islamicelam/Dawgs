        ...
        <div className="bg-white rounded-xl p-6 w-[500px] shadow-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 mt-2">
              <button onClick={handleSave} className="flex-1 bg-slate-800 text-white rounded-lg py-2 text-sm hover:bg-slate-700 transition-colors">Save</button>
              <button onClick={onClose} className="flex-1 bg-slate-100 text-slate-500 rounded-lg py-2 text-sm hover:bg-slate-200 transition-colors">Cancel</button>
            </div>
          </div>
        </div>
      </div>
